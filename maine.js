...
<input type="text" id="searchBar" class="search-input" placeholder="Search..." onkeyup="filterGames()">
</div>
<div class="container">
...
var img=document.createElement("img");img.src=game.img;
var label=document.createElement("span");label.textContent=game.name;
